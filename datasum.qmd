...
Some enteric disease data are pathogen-specific, especially from surveillance systems in high-income countries. Some pathogens were derived from ICD 10 codes A00 to A09. The major pathogens included in the compiled dataset are shown in @tbl-pathogen.
...
The raw enteric diseases data were processed into weekly time series at the most appropriate subnational administrative level (i.e., aggregation at higher subnational level were done whenever number of cases are too few). The weekly format were mostly in ISO weeks and some countries were in EPI week to follow a consistent 7-day aggregation with the year value following the ISO and EPI week formats. @fig-easia, @fig-europe, and @fig-mnl1 are sample plots of spatial and temporal resolution of the processed enteric disease dataset.

![Total all-cause enteric disease cases by subnational units of East Asian nations. Number of cases are shown in quartiles by nation because each system varies and numbers of cases are very high in South Korea.](climed_website_fig1.png){#fig-easia width="700"}

![Total Campylobacter cases by subnational units of some European countries. Country-level reports from Spain, France, Norway, and others are excluded.](climed_website_fig2.png){#fig-europe width="700"}
...
![Weekly tropical cylone maximum winds and total rainfall in Metro Manila, Philippines. Red circles are wind speeds and blue bars are total rainfall.](climed_website_fig5.png){#fig-mnl3 width="800"}
